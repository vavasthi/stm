...
public class RegisterUserAsyncTask extends AsyncTask<Void, Void, Integer> {
    ...
    public RegisterUserAsyncTask(KhanaKiranaMainActivity context,
        ...
        if (((CheckBox)context.findViewById(R.id.chooseLocation)).isChecked() && context.registrationLocation != null) {
            this.latitude = context.registrationLocation.getLatitude();
            this.longitude = context.registrationLocation.getLatitude();
        }
        else {

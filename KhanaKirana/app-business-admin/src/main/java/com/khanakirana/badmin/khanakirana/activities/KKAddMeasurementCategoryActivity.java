...
/*        ((Button) layout.findViewById(R.id.register)).setOnClickListener(new View.OnClickListener() {
    ...
    public void addMeasurementCategory(View v) {
        ...
        progressDialog.show();
        new com.khanakirana.badmin.khanakirana.background.tasks.AddMeasurementCategoryTask(this, KhanaKiranaMainActivity.getEndpoints(), measurementCategory, fractional).execute();

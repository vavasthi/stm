...
/**
 * Created by vavasthi on 20/9/15.
 */
...
public class IntentIntegrator {
     ...
     */
    public static com.khanakirana.admin.khanakirana.IntentResult parseActivityResult(int requestCode, int resultCode, Intent intent) {

...
public interface DeviceRegistrationTempAuthTokenDao extends CrudRepository<DeviceRegistrationTempAuthTokenEntity, UUID> {
  ...
  @Query("SELECT re from  com.hubbleconnected.server.identity.entity.DeviceRegistrationTempAuthTokenEntity re where re.name = :deviceRegistrationId ")
  ...
  @Query("SELECT re from  com.hubbleconnected.server.identity.entity.DeviceRegistrationTempAuthTokenEntity re where re.tempAuthToken = :tempAuthToken ")
  List<DeviceRegistrationTempAuthTokenEntity> findByTempAuthToken(@Param("tempAuthToken") String tempAuthToken);

  @Query("SELECT re from  com.hubbleconnected.server.identity.entity.DeviceRegistrationTempAuthTokenEntity re where re.deviceEntity = :deviceEntity ")

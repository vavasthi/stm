...
package com.sanjnan.server;

import com.fasterxml.jackson.databind.Module;
import com.fasterxml.jackson.datatype.joda.JodaModule;
import com.sanjnan.server.config.annotations.ORMCache;
import com.sanjnan.server.dao.TenantDao;
import com.sanjnan.server.security.SanjnanAuditorAware;
import com.sanjnan.server.security.provider.SanjnanAuditingDateTimeProvider;
import com.sanjnan.server.service.DateTimeService;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"com.sanjnan.server"})
@EnableAutoConfiguration
@EnableConfigurationProperties
@EnableJpaRepositories(basePackages = {"com.sanjnan.server.dao"})

...
import com.sanjnan.vitarak.app.sadmin.activities.KKAddProductInMasterListActivity;
    ...
    protected Integer doInBackground(Void... params) {
        ...
        try{
            ...
            RequestBody body = new MultipartBuilder(IMAGE_PART_NAME)
                    ...
                    .addFormDataPart(SanjnanAndroidConstants.BLOB_STORE_KEY_FILE, filename, RequestBody.create(MediaType.parse("image/png"), content))
                    .build();
            ...
            String cloudKey = response.header(SanjnanAndroidConstants.BLOB_CLOUD_KEY);

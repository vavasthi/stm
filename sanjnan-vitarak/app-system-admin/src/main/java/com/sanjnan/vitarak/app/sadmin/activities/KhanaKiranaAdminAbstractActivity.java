...
import com.sanjnan.vitarak.app.sadmin.adapters.KKRecyclerViewMainScreenAdapter;
...
import com.sanjnan.vitarak.common.SanjnanActionTypes;
import com.sanjnan.vitarak.common.SanjnanStringCodes;
...
abstract class KhanaKiranaAdminAbstractActivity extends Activity {
    ...
    public void splashMainScreen(List<Actionable> actionables) {
        ...
        if (actionables == null || actionables.size() == 0) {
            ...
            actionable.setActionType(SanjnanActionTypes.NOTHING_TO_DO);
            actionable.setTitle(SanjnanStringCodes.ACTIONABLE_NOTHING_TO_DO_TITLE);
            actionable.setDescription(SanjnanStringCodes.ACTIONABLE_NOTHING_TO_DO_DESCRIPTION);;

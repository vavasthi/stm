package com.sanjnan.vitarak.server.backend.servlet;
...
public class KKUpload extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        List<BlobKey> blobKeys = blobs.get(SanjnanConstants.BLOB_STORE_KEY_FILE);
        if (blobKeys == null || blobKeys.isEmpty()) {
        } else {
            res.setHeader(SanjnanConstants.BLOB_CLOUD_KEY, blobKeys.get(0).getKeyString());
        }
    }
}
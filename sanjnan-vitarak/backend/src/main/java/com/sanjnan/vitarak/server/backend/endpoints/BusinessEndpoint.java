...
public class BusinessEndpoint extends BaseEndpoint {
    ...
    public BusinessAccountResult register(@Named("name") String name,
        ...
        try {
            ...
            BusinessEstablishmentAccount account = findBusinessUser(user);
            if (account != null) {
        ...
        BusinessEstablishmentAccount account
                = new BusinessEstablishmentAccount(name, address, user.getEmail().toLowerCase(), mobile, city, state, longitude, latitude);
    ...
    public MasterItem registerMasterItem(@Named("name") String name,
        ...
        BusinessEstablishmentAccount account = authorizeBusinessUser(user);
        if (account == null) {
            throw new ForbiddenException(user.getEmail() + " is an invalid user.");
        }
        MasterItem masterItem = new MasterItem(name,
                description,
                upc,
                imageType,
                imageCloudKey,
    ...
    public List<MeasurementCategory> lisMeasurementCategories(User user)
            throws MeasurementCategoryDoesntExist,
            MeasurementPrimaryUnitException,
            MeasurementCategoryAlreadyExists,
            OAuthRequestException,
            ForbiddenException {
    ...
    public List<MeasurementUnit>
    getUnitsForCategory(@Named("measurementCategory") String measurementCategory,
                        User user)
            throws MeasurementCategoryDoesntExist,
            OAuthRequestException,
            ForbiddenException {

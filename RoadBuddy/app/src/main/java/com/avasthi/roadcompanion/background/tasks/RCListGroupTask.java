 ...
 */
public class RCListGroupTask extends AsyncTask<Void, Void, List<UserGroup> > {

    private final RCGroupActivity context;

    private Logger logger = Logger.getLogger(RCListGroupTask.class.getName());

    public RCListGroupTask(RCGroupActivity context) {

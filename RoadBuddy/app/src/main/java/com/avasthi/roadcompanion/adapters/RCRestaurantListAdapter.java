 ...
 */
public class RCRestaurantListAdapter extends RecyclerView.Adapter<RCRestaurantListAdapter.DataObjectHolder> {

    RCRestaurantActivity activity;
    private final Toll[] tolls;
    private int position = -1;

    public RCRestaurantListAdapter(List<Toll> dataset, RCRestaurantActivity activity) {

...
import com.avasthi.roadcompanion.adapters.RCRestaurantListAdapter;
 ...
 */
public class RCRestaurantActivity extends RCAbstractActivity {

    private RecyclerView recyclerView;
    private RCRestaurantListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rc_restaurant_popup);
    ...
    public void populateListView() {
        ...
        if (pointsOfInterest != null &&
            ...
            adapter = new RCRestaurantListAdapter(pointsOfInterest.getTollList(), this);

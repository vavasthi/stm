 ...
 */
public class RCFuelListAdapter extends RecyclerView.Adapter<RCFuelListAdapter.DataObjectHolder> {

    RCFuelActivity activity;
    private final Toll[] tolls;
    private int position = -1;

    public RCFuelListAdapter(List<Toll> dataset, RCFuelActivity activity) {

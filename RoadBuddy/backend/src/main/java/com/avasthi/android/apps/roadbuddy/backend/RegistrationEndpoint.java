 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.roadbuddy.apps.android.avasthi.com", ownerName = "backend.roadbuddy.apps.android.avasthi.com", packagePath = ""))

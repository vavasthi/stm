...
/**
 * Service definition for GcmSenderEndpoint (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link GcmSenderEndpointRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class GcmSenderEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the gcmSenderEndpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "gcmSenderEndpoint/v1/sendMessage/";
   ...
   * @since 1.7
   */
  public GcmSenderEndpoint(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  GcmSenderEndpoint(Builder builder) {
    super(builder);
  }
   ...
   * <pre>
   *   {@code GcmSenderEndpoint gcmSenderEndpoint = new GcmSenderEndpoint(...);}
   *   {@code GcmSenderEndpoint.MessagingEndpoint.List request = gcmSenderEndpoint.messagingEndpoint().list(parameters ...)}
   * </pre>
   *
  ...
  public class MessagingEndpoint {
     ...
     *
     * This request holds the parameters needed by the gcmSenderEndpoint server.  After setting any
    ...
    public class SendMessage extends GcmSenderEndpointRequest<Void> {
       ...
       * Create a request for the method "messagingEndpoint.sendMessage".
       *
       * This request holds the parameters needed by the the gcmSenderEndpoint server.  After setting
      ...
      protected SendMessage(java.lang.String message) {
        super(GcmSenderEndpoint.this, "POST", REST_PATH, null, Void.class);
  ...
  /**
   * Builder for {@link GcmSenderEndpoint}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link GcmSenderEndpoint}. */
    @Override
    public GcmSenderEndpoint build() {
      return new GcmSenderEndpoint(this);
    }
    ...
    /**
     * Set the {@link GcmSenderEndpointRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setGcmSenderEndpointRequestInitializer(
        GcmSenderEndpointRequestInitializer gcmsenderendpointRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(gcmsenderendpointRequestInitializer);
    }

 ...
 * on 2015-12-17 at 17:44:11 UTC 
 * Modify at your own risk.
 */

package com.avasthi.android.apps.roadbuddy.backend.registerGoogleCloudMessagingApi;

/**
 * Service definition for RegisterGoogleCloudMessagingApi (v1).
 *
 * <p>
 * This is an API
 * </p>
 ...
 *
 * <p>
 * This service uses {@link RegisterGoogleCloudMessagingApiRequestInitializer} to initialize global parameters via its
 * {@link Builder}.
 * </p>
 *
 * @since 1.3
...
public class RegisterGoogleCloudMessagingApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the registerGoogleCloudMessagingApi library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "registerGoogleCloudMessagingApi/v1/";
   ...
   * @since 1.7
   */
  public RegisterGoogleCloudMessagingApi(com.google.api.client.http.HttpTransport transport, com.google.api.client.json.JsonFactory jsonFactory,
   ...
   */
  RegisterGoogleCloudMessagingApi(Builder builder) {
    super(builder);
  }
   ...
   *
   * This request holds the parameters needed by the registerGoogleCloudMessagingApi server.  After
   * setting any optional parameters, call the {@link ListDevices#execute()} method to invoke the
   * remote operation.
   *
   * @param count
   * @return the request
  ...
  public class ListDevices extends RegisterGoogleCloudMessagingApiRequest<com.avasthi.android.apps.roadbuddy.backend.registerGoogleCloudMessagingApi.model.CollectionResponseRegistrationRecord> {
     ...
     * Create a request for the method "listDevices".
     *
     * This request holds the parameters needed by the the registerGoogleCloudMessagingApi server.
     * After setting any optional parameters, call the {@link ListDevices#execute()} method to invoke
    ...
    protected ListDevices(java.lang.Integer count) {
      super(RegisterGoogleCloudMessagingApi.this, "GET", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.registerGoogleCloudMessagingApi.model.CollectionResponseRegistrationRecord.class);
   ...
   *
   * This request holds the parameters needed by the registerGoogleCloudMessagingApi server.  After
   * setting any optional parameters, call the {@link Register#execute()} method to invoke the remote
   * operation.
   *
   * @param regId
   * @return the request
  ...
  public class Register extends RegisterGoogleCloudMessagingApiRequest<Void> {
     ...
     *
     * This request holds the parameters needed by the the registerGoogleCloudMessagingApi server.
     * After setting any optional parameters, call the {@link Register#execute()} method to invoke the
    ...
    protected Register(java.lang.String regId) {
      super(RegisterGoogleCloudMessagingApi.this, "POST", REST_PATH, null, Void.class);
   ...
   *
   * This request holds the parameters needed by the registerGoogleCloudMessagingApi server.  After
   * setting any optional parameters, call the {@link Unregister#execute()} method to invoke the
   * remote operation.
   *
   * @param regId
   * @return the request
  ...
  public class Unregister extends RegisterGoogleCloudMessagingApiRequest<Void> {
     ...
     *
     * This request holds the parameters needed by the the registerGoogleCloudMessagingApi server.
     * After setting any optional parameters, call the {@link Unregister#execute()} method to invoke
     * the remote operation. <p> {@link
  ...
  /**
   * Builder for {@link RegisterGoogleCloudMessagingApi}.
   *
   * <p>
  ...
  public static final class Builder extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient.Builder {
    ...
    /** Builds a new instance of {@link RegisterGoogleCloudMessagingApi}. */
    @Override
    public RegisterGoogleCloudMessagingApi build() {
      return new RegisterGoogleCloudMessagingApi(this);
    }
    ...
    /**
     * Set the {@link RegisterGoogleCloudMessagingApiRequestInitializer}.
     *
     * @since 1.12
     */
    public Builder setRegisterGoogleCloudMessagingApiRequestInitializer(
        RegisterGoogleCloudMessagingApiRequestInitializer registergooglecloudmessagingapiRequestInitializer) {
      return (Builder) super.setGoogleClientRequestInitializer(registergooglecloudmessagingapiRequestInitializer);
    }

...
public class RoadMeasurementApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.22.0 of the roadMeasurementApi library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class RoadMeasurementBeanEndpoint {
    ...
    /**
     * Create a request for the method "roadMeasurementBeanEndpoint.sendMessage".
     *
    ...
    public class SendMessage extends RoadMeasurementApiRequest<Void> {
      ...
      protected SendMessage(java.lang.String message) {
        super(RoadMeasurementApi.this, "POST", REST_PATH, null, Void.class);
  ...
  public class AddAmenity extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
    ...
    protected AddAmenity(com.google.api.client.util.DateTime timestamp, java.lang.String name, java.lang.Double latitude, java.lang.Double longitude, java.lang.Boolean hasRestaurant, java.lang.Boolean restaurantCreditCardAccepted, java.lang.Float foodAmount, java.lang.Integer restaurantRating, java.lang.Boolean hasRestrooms, java.lang.Integer restroomRating, java.lang.Boolean hasPetroStation, java.lang.Boolean fuelCreditCardAccepted, java.lang.Integer petrolStationRating, java.lang.Float fuelAmount, java.lang.Float fuelQuantity, java.lang.String city, java.lang.String sate, java.lang.String country) {
      super(RoadMeasurementApi.this, "POST", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest.class);
  ...
  public class AddAmenityStop extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
  ...
  public class AddCheckpost extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
  ...
  public class AddCheckpostStop extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
  ...
  public class AddToll extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
  ...
  public class AddTollStop extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
   ...
   * @return the request
   */
  public FinishDrive finishDrive(java.lang.Double latitude, java.lang.Double longitude) throws java.io.IOException {
    FinishDrive result = new FinishDrive(latitude, longitude);
    initialize(result);
    return result;
  }

  public class FinishDrive extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {

    private static final String REST_PATH = "finishDrive/{latitude}/{longitude}";
     ...
     * @since 1.13
     */
    protected FinishDrive(java.lang.Double latitude, java.lang.Double longitude) {
      super(RoadMeasurementApi.this, "POST", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest.class);
      this.latitude = com.google.api.client.util.Preconditions.checkNotNull(latitude, "Required parameter latitude must be specified.");
      this.longitude = com.google.api.client.util.Preconditions.checkNotNull(longitude, "Required parameter longitude must be specified.");
    }
    ...
    public FinishDrive setLatitude(java.lang.Double latitude) {
      this.latitude = latitude;
      return this;
    }
    ...
    public FinishDrive setLongitude(java.lang.Double longitude) {
      this.longitude = longitude;
      return this;
    }
  ...
  /**
   * Create a request for the method "getFamilyDrives".
   *
   * This request holds the parameters needed by the roadMeasurementApi server.  After setting any
   * optional parameters, call the {@link GetFamilyDrives#execute()} method to invoke the remote
   * operation.
   *
   * @return the request
   */
  public GetFamilyDrives getFamilyDrives() throws java.io.IOException {
    GetFamilyDrives result = new GetFamilyDrives();
    initialize(result);
    return result;
  }

  public class GetFamilyDrives extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.FamilyMemberAndPointsOfInterestCollection> {

    private static final String REST_PATH = "familymemberandpointsofinterestcollection";

    /**
     * Create a request for the method "getFamilyDrives".
     *
     * This request holds the parameters needed by the the roadMeasurementApi server.  After setting
     * any optional parameters, call the {@link GetFamilyDrives#execute()} method to invoke the remote
     * operation. <p> {@link GetFamilyDrives#initialize(com.google.api.client.googleapis.services.Abst
     * ractGoogleClientRequest)} must be called to initialize this instance immediately after invoking
     * the constructor. </p>
     *
     * @since 1.13
     */
    protected GetFamilyDrives() {
      super(RoadMeasurementApi.this, "GET", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.FamilyMemberAndPointsOfInterestCollection.class);
    }
    ...
    @Override
    public GetFamilyDrives setAlt(java.lang.String alt) {
      return (GetFamilyDrives) super.setAlt(alt);
    }

    @Override
    public GetFamilyDrives setFields(java.lang.String fields) {
      return (GetFamilyDrives) super.setFields(fields);
    }

    @Override
    public GetFamilyDrives setKey(java.lang.String key) {
      return (GetFamilyDrives) super.setKey(key);
    }

    @Override
    public GetFamilyDrives setOauthToken(java.lang.String oauthToken) {
      return (GetFamilyDrives) super.setOauthToken(oauthToken);
    }

    @Override
    public GetFamilyDrives setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetFamilyDrives) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetFamilyDrives setQuotaUser(java.lang.String quotaUser) {
      return (GetFamilyDrives) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetFamilyDrives setUserIp(java.lang.String userIp) {
      return (GetFamilyDrives) super.setUserIp(userIp);
    }

    @Override
    public GetFamilyDrives set(String parameterName, Object value) {
      return (GetFamilyDrives) super.set(parameterName, value);
    }
  }
  ...
  public class ListDevices extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(RoadMeasurementApi.this, "GET", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.CollectionResponseRegistrationRecord.class);
  ...
  public class RegisterDevice extends RoadMeasurementApiRequest<Void> {
  ...
  public class StartDrive extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
  ...
  /**
   * Create a request for the method "unregisterDevice".
   *
   * This request holds the parameters needed by the roadMeasurementApi server.  After setting any
  ...
  public class UnregisterDevice extends RoadMeasurementApiRequest<Void> {
  ...
  public UpdateSensorData updateSensorData(com.google.api.client.util.DateTime timestamp, java.lang.Long memberId, java.lang.Long driveId, java.lang.Float verticalAccelerometerMean, java.lang.Float verticalAccelerometerSD, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float speed, java.lang.Float accuracy, java.lang.Float bearing, java.lang.Float distance) throws java.io.IOException {
    UpdateSensorData result = new UpdateSensorData(timestamp, memberId, driveId, verticalAccelerometerMean, verticalAccelerometerSD, latitude, longitude, speed, accuracy, bearing, distance);
    initialize(result);
    return result;
  }
  ...
  public class UpdateSensorData extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
    ...
    private static final String REST_PATH = "pointsofinterest/{timestamp}/{memberId}/{driveId}/{verticalAccelerometerMean}/{verticalAccelerometerSD}/{latitude}/{longitude}/{speed}/{accuracy}/{bearing}/{distance}";
    ...
    public UpdateSensorData setMemberId(java.lang.Long memberId) {
    ...
    public UpdateSensorData setDriveId(java.lang.Long driveId) {
      this.driveId = driveId;
      return this;
    }

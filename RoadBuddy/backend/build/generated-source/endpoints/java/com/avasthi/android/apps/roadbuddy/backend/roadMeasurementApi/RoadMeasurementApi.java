...
public class RoadMeasurementApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public AddAmenity addAmenity(com.google.api.client.util.DateTime timestamp, java.lang.String name, java.lang.Double latitude, java.lang.Double longitude, java.lang.Boolean hasRestaurant, java.lang.Boolean hasRestrooms, java.lang.Boolean hasPetroStation, java.lang.String city, java.lang.String sate, java.lang.String country) throws java.io.IOException {
    AddAmenity result = new AddAmenity(timestamp, name, latitude, longitude, hasRestaurant, hasRestrooms, hasPetroStation, city, sate, country);
    initialize(result);
    return result;
  }
  ...
  public class AddAmenity extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.Amenity> {
    ...
    private static final String REST_PATH = "addAmenity/{timestamp}/{name}/{latitude}/{longitude}/{hasRestaurant}/{hasRestrooms}/{hasPetroStation}/{city}/{sate}/{country}";
   ...
   * @param creditCardAccepted
   * @return the request
   */
  public AddAmenityStop addAmenityStop(java.lang.Long establishmentId, com.google.api.client.util.DateTime timestamp, java.lang.Integer restaurantRating, java.lang.Integer restroomRating, java.lang.Integer petrolStationRating, java.lang.Boolean creditCardAccepted) throws java.io.IOException {
    AddAmenityStop result = new AddAmenityStop(establishmentId, timestamp, restaurantRating, restroomRating, petrolStationRating, creditCardAccepted);
    initialize(result);
    return result;
  }
  ...
  public class AddAmenityStop extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.AmenityStop> {
    ...
    private static final String REST_PATH = "addAmenityVisit/{establishmentId}/{timestamp}/{restaurantRating}/{restroomRating}/{petrolStationRating}/{creditCardAccepted}";
     ...
     * @since 1.13
     */
    protected AddAmenityStop(java.lang.Long establishmentId, com.google.api.client.util.DateTime timestamp, java.lang.Integer restaurantRating, java.lang.Integer restroomRating, java.lang.Integer petrolStationRating, java.lang.Boolean creditCardAccepted) {
      ...
      this.creditCardAccepted = com.google.api.client.util.Preconditions.checkNotNull(creditCardAccepted, "Required parameter creditCardAccepted must be specified.");
    }
    ...
    public AddAmenityStop setCreditCardAccepted(java.lang.Boolean creditCardAccepted) {
   ...
   * @return the request
   */
  public AddCheckpost addCheckpost(com.google.api.client.util.DateTime timestamp, java.lang.Double latitude, java.lang.Double longitude, java.lang.String city, java.lang.String sate, java.lang.String country) throws java.io.IOException {
    AddCheckpost result = new AddCheckpost(timestamp, latitude, longitude, city, sate, country);
    initialize(result);
    return result;
  }
  ...
  public class AddCheckpost extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.Checkpost> {
    ...
    private static final String REST_PATH = "addCheckpost/{timestamp}/{latitude}/{longitude}/{city}/{sate}/{country}";
     ...
     * @since 1.13
     */
    protected AddCheckpost(com.google.api.client.util.DateTime timestamp, java.lang.Double latitude, java.lang.Double longitude, java.lang.String city, java.lang.String sate, java.lang.String country) {
   ...
   * @return the request
   */
  public AddCheckpostStop addCheckpostStop(java.lang.Long establishmentId, com.google.api.client.util.DateTime timestamp, java.lang.Boolean speedCameras) throws java.io.IOException {
    AddCheckpostStop result = new AddCheckpostStop(establishmentId, timestamp, speedCameras);
    initialize(result);
    return result;
  }
  ...
  public class AddCheckpostStop extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.CheckpostStop> {
    ...
    private static final String REST_PATH = "addCheckpostStop/{establishmentId}/{timestamp}/{speedCameras}";
     ...
     * @since 1.13
     */
    protected AddCheckpostStop(java.lang.Long establishmentId, com.google.api.client.util.DateTime timestamp, java.lang.Boolean speedCameras) {
  ...
  public AddSensorData addSensorData(com.google.api.client.util.DateTime timestamp, java.lang.Float verticalAccelerometerMean, java.lang.Float verticalAccelerometerSD, java.lang.Float accuracy, java.lang.Float bearing, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float speed) throws java.io.IOException {
    AddSensorData result = new AddSensorData(timestamp, verticalAccelerometerMean, verticalAccelerometerSD, accuracy, bearing, latitude, longitude, speed);
    initialize(result);
    return result;
  }
  ...
  public class AddSensorData extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.SensorData> {
    ...
    private static final String REST_PATH = "addSensorData/{timestamp}/{verticalAccelerometerMean}/{verticalAccelerometerSD}/{accuracy}/{bearing}/{latitude}/{longitude}/{speed}";
     ...
     * @since 1.13
     */
    protected AddSensorData(com.google.api.client.util.DateTime timestamp, java.lang.Float verticalAccelerometerMean, java.lang.Float verticalAccelerometerSD, java.lang.Float accuracy, java.lang.Float bearing, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float speed) {
   ...
   * @return the request
   */
  public AddToll addToll(com.google.api.client.util.DateTime timestamp, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float amount, java.lang.String city, java.lang.String sate, java.lang.String country) throws java.io.IOException {
    AddToll result = new AddToll(timestamp, latitude, longitude, amount, city, sate, country);
    initialize(result);
    return result;
  }
  ...
  public class AddToll extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.Toll> {
    ...
    private static final String REST_PATH = "addToll/{timestamp}/{latitude}/{longitude}/{amount}/{city}/{sate}/{country}";
     ...
     * @since 1.13
     */
    protected AddToll(com.google.api.client.util.DateTime timestamp, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float amount, java.lang.String city, java.lang.String sate, java.lang.String country) {
   ...
   * @return the request
   */
  public AddTollStop addTollStop(java.lang.Long establishmentId, com.google.api.client.util.DateTime timestamp, java.lang.Float amount, java.lang.Boolean fasTagLane) throws java.io.IOException {
    AddTollStop result = new AddTollStop(establishmentId, timestamp, amount, fasTagLane);
    initialize(result);
    return result;
  }

  public class AddTollStop extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.TollStop> {

    private static final String REST_PATH = "addTollStop/{establishmentId}/{timestamp}/{amount}/{fasTagLane}";
     ...
     * @since 1.13
     */
    protected AddTollStop(java.lang.Long establishmentId, com.google.api.client.util.DateTime timestamp, java.lang.Float amount, java.lang.Boolean fasTagLane) {
      super(RoadMeasurementApi.this, "POST", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.TollStop.class);
      this.establishmentId = com.google.api.client.util.Preconditions.checkNotNull(establishmentId, "Required parameter establishmentId must be specified.");
      this.timestamp = com.google.api.client.util.Preconditions.checkNotNull(timestamp, "Required parameter timestamp must be specified.");
      this.amount = com.google.api.client.util.Preconditions.checkNotNull(amount, "Required parameter amount must be specified.");
   ...
   * @return the request
   */
  public UpdateSensorData updateSensorData(com.google.api.client.util.DateTime timestamp, java.lang.Float verticalAccelerometerMean, java.lang.Float verticalAccelerometerSD, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float speed, java.lang.Float accuracy, java.lang.Float bearing) throws java.io.IOException {
    UpdateSensorData result = new UpdateSensorData(timestamp, verticalAccelerometerMean, verticalAccelerometerSD, latitude, longitude, speed, accuracy, bearing);
    initialize(result);
    return result;
  }
  ...
  public class UpdateSensorData extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.PointsOfInterest> {
    ...
    private static final String REST_PATH = "pointsofinterest/{timestamp}/{verticalAccelerometerMean}/{verticalAccelerometerSD}/{latitude}/{longitude}/{speed}/{accuracy}/{bearing}";
     ...
     * @since 1.13
     */
    protected UpdateSensorData(com.google.api.client.util.DateTime timestamp, java.lang.Float verticalAccelerometerMean, java.lang.Float verticalAccelerometerSD, java.lang.Double latitude, java.lang.Double longitude, java.lang.Float speed, java.lang.Float accuracy, java.lang.Float bearing) {

...
public class RoadMeasurementApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Register register(java.lang.String name, java.lang.String mobile, java.lang.String city, java.lang.String state, java.lang.String detectedCity, java.lang.String detectedState, java.lang.Double latitude, java.lang.Double logitude, java.lang.String facebookUserId) throws java.io.IOException {
    Register result = new Register(name, mobile, city, state, detectedCity, detectedState, latitude, logitude, facebookUserId);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RoadMeasurementApiRequest<com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.Member> {
    ...
    private static final String REST_PATH = "register/{name}/{mobile}/{city}/{state}/{detectedCity}/{detectedState}/{latitude}/{logitude}/{facebookUserId}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String name, java.lang.String mobile, java.lang.String city, java.lang.String state, java.lang.String detectedCity, java.lang.String detectedState, java.lang.Double latitude, java.lang.Double logitude, java.lang.String facebookUserId) {
      super(RoadMeasurementApi.this, "POST", REST_PATH, null, com.avasthi.android.apps.roadbuddy.backend.roadMeasurementApi.model.Member.class);
    ...
    public Register setFacebookUserId(java.lang.String facebookUserId) {

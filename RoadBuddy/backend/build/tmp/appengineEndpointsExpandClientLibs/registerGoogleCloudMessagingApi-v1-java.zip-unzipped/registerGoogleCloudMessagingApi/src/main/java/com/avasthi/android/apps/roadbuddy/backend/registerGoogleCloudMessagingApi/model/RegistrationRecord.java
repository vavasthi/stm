...
package com.avasthi.android.apps.roadbuddy.backend.registerGoogleCloudMessagingApi.model;

/**
 * Model definition for RegistrationRecord.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the registerGoogleCloudMessagingApi. For a detailed
 * explanation see:

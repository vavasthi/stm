 ...
 */
public class RoadCompanionLocationManager implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private static RoadCompanionLocationManager INSTANCE;

    public static synchronized  void initialize(Activity context, Locale locale) {
        INSTANCE = new RoadCompanionLocationManager(context, locale);
        INSTANCE.initializeLocationService();
    }

    public static RoadCompanionLocationManager getInstance() {
        return INSTANCE;
    }
    private RoadCompanionLocationManager(Activity context, Locale locale) {

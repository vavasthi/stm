...
import com.avasthi.roadcompanion.background.tasks.AddMeasurementCategoryTask;
 ...
 */
public class KKAddMeasurementCategoryActivity extends RoadCompanionAbstractActivity {
...
/*        ((Button) layout.findViewById(R.id.register)).setOnClickListener(new View.OnClickListener() {
    ...
    public void addMeasurementCategory(View v) {
        ...
        progressDialog.show();
        new AddMeasurementCategoryTask(this, measurementCategory, fractional).execute();
